...
from autoPyTorch.pipeline.components.setup.predefined_models.custom_learners.base_traditional_learner import \
    BaseCustomLearner
from autoPyTorch.pipeline.components.setup.predefined_models.custom_learners.lgbm.lgbm_utils import early_stopping_custom, get_metric, get_params as lgb_get_params, get_train_loss_name



class LGBModel(BaseCustomLearner):
    def __init__(self,
                 task_type: str,
                 output_type: str,
