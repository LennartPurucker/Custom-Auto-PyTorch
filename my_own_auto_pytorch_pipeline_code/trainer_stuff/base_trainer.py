...
from my_own_auto_pytorch_pipeline_code.trainer_stuff.utils import Lookahead, swa_update
from my_own_auto_pytorch_pipeline_code.trainer_stuff.implementations import get_loss_weight_strategy
...
class BaseTrainerComponent:
    ...
    def on_epoch_end(self, is_cyclic_scheduler, epoch: int) -> bool:
        if is_cyclic_scheduler:
